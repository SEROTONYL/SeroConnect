  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        text: "Установите рекомендуемое приложение для подключения VPN.",
      },
      {
        title: "Откройте приложение и импортируйте ссылку",
        text: "Откройте приложение, добавьте новую конфигурацию и импортируйте ранее скопированную ссылку.",
      },
      {
        title: "Включите VPN",
        text: "Выберите добавленную конфигурацию и включите VPN.",
      },
    ],
  },
  {
